...
/client/proc/force_white_theme() //There's no way round it. We're essentially changing the skin by hand. It's painful but it works, and is the way Lummox suggested.
	...
	winset(src, "split", "background-color = #494949;background-color = none")
	winset(src, "split", "text-color = [COLOR_DARKMODE_TEXT];text-color = #000000")
	winset(src, "tooltip", "background-color = #494949;background-color = none")
...
/client/proc/force_dark_theme() //Inversely, if theyre using white theme and want to swap to the superior dark theme, let's get WINSET() ing
	...
	winset(src, "stat", "background-color = none;background-color = [COLOR_DARKMODE_DARKBACKGROUND]")
	...
	winset(src, "saybutton", "background-color = none;background-color = #494949")
	winset(src, "saybutton", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "oocbutton", "background-color = none;background-color = #494949")
	winset(src, "oocbutton", "text-color = #000000;text-color = [COLOR_DARKMODE_TEXT]")
	winset(src, "mebutton", "background-color = none;background-color = #494949")
