...
GLOBAL_LIST_INIT(department_radio_keys, list(
	...
	// Department
	"Г°" = MODE_DEPARTMENT,
	"Г±" = RADIO_CHANNEL_COMMAND,
	"ГІ" = RADIO_CHANNEL_SCIENCE,
	"Гј" = RADIO_CHANNEL_MEDICAL,
	"Гі" = RADIO_CHANNEL_ENGINEERING,
	"Г»" = RADIO_CHANNEL_SECURITY,
	"ГЈ" = RADIO_CHANNEL_SUPPLY,
	"Г¬" = RADIO_CHANNEL_SERVICE,

	// Faction
	"ГҐ" = RADIO_CHANNEL_SYNDICATE,
	"Г­" = RADIO_CHANNEL_CENTCOM,
